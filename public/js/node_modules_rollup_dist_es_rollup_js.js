...
const normalizePath = function normalizePath(filename) {
    return filename.split(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'path'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).sep).join(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'path'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).sep);
};
...
class VariableDeclarator extends NodeBase {
    ...
    render(code, options) {
        ...
        if (init) {
            ...
            init.render(code, options, renderId ? BLANK : { renderedSurroundingElement: _parseAst_js__WEBPACK_IMPORTED_MODULE_0__.ExpressionStatement });
        }
...
class PanicError extends NodeBase {
    initialise() {
        ...
        const parseError = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.getRollupEror)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.logParseError)(this.message));
...
class ParseError extends NodeBase {
    initialise() {
        ...
        // This simulates the current nested error structure. We could also just
        // replace it with a flat error.
        const parseError = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.getRollupEror)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.logParseError)(this.message, pos));
        const moduleParseError = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.logModuleParseError)(parseError, id);
...
function convertProgram(buffer, parent, parentScope) {
    return convertNode(parent, parentScope, 0, new Uint32Array(buffer.buffer), (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.getReadStringFunction)(buffer));
}
...
const bufferParsers = [
    function panicError(node, position, buffer, readString) {
        node.message = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertString)(position, buffer, readString);
    },
    ...
    function arrowFunctionExpression(node, position, buffer, readString) {
        ...
        const annotations = (node.annotations = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertAnnotations)(position + 3, buffer));
    ...
    function callExpression(node, position, buffer, readString) {
        ...
        node.annotations = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertAnnotations)(position + 3, buffer);
    },
    ...
    function directive(node, position, buffer, readString) {
        ...
        node.directive = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertString)(position + 1, buffer, readString);
    },
    ...
    function functionDeclaration(node, position, buffer, readString) {
        ...
        const annotations = (node.annotations = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertAnnotations)(position + 4, buffer));
        node.annotationNoSideEffects = annotations.some(comment => comment.type === 'noSideEffects');
    },
    ...
    function identifier(node, position, buffer, readString) {
        node.name = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertString)(position, buffer, readString);
    },
    ...
    function importExpression(node, position, buffer, readString) {
        ...
        node.sourceAstNode = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertNode)(position + 1, buffer, readString);
    },
    ...
    function literalBigInt(node, position, buffer, readString) {
        node.raw = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertString)(buffer[position], buffer, readString);
        const bigint = (node.bigint = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertString)(position + 1, buffer, readString));
    ...
    function literalNumber(node, position, buffer, readString) {
        ...
        node.raw = rawPosition === 0 ? undefined : (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertString)(rawPosition, buffer, readString);
        node.value = new DataView(buffer.buffer).getFloat64((position + 1) << 2, true);
    },
    function literalRegExp(node, position, buffer, readString) {
        const pattern = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertString)(buffer[position], buffer, readString);
        const flags = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertString)(position + 1, buffer, readString);
    ...
    function literalString(node, position, buffer, readString) {
        const rawPosition = buffer[position];
        node.raw = rawPosition === 0 ? undefined : (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertString)(rawPosition, buffer, readString);
        node.value = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertString)(position + 1, buffer, readString);
    },
    ...
    function methodDefinition(node, position, buffer, readString) {
        ...
        node.kind = _parseAst_js__WEBPACK_IMPORTED_MODULE_0__.FIXED_STRINGS[buffer[position + 2]];
    ...
    function newExpression(node, position, buffer, readString) {
        ...
        node.annotations = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertAnnotations)(position + 2, buffer);
    },
    ...
    function program(node, position, buffer, readString) {
        const { scope } = node;
        node.invalidAnnotations = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertAnnotations)(buffer[position], buffer);
    ...
    function templateElement(node, position, buffer, readString) {
        ...
        const cooked = cookedPosition === 0 ? undefined : (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertString)(cookedPosition, buffer, readString);
        const raw = (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.convertString)(position + 2, buffer, readString);
...
const getExtendedLogMessage = (log) => {
    ...
    if (log.loc) {
        prefix += `${(0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.relativeId)(log.loc.file)} (${log.loc.line}:${log.loc.column}) `;
    }
